  ...
  return (
    <Container style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
      ...
      <form onSubmit={submitFormHandler}>
        {showForm && (
          <Grid container sx={{ justifyContent: 'space-between', maxWidth: '600px', margin: '0 auto', my: 2 }}>
            <FormElement value={form.bouquet_name} label="Название" name="bouquet_name" onChange={inputChangeHandler} />
            <FormElement
            ...
            <BasicSelect
              ...
              options={
                categories ? categories.map((category) => ({ id: category.id, name: category.category_name })) : []
              }
            />
